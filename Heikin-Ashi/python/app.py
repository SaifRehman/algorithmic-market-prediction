...
if __name__ == '__main__':
    schedule.every().day.at("01:00 UTC").do(sms)
    schedule.every().day.at("03:00 UTC").do(sms)
    schedule.every().day.at("05:00 UTC").do(sms)
    schedule.every().day.at("07:00 UTC").do(sms)
    schedule.every().day.at("09:00 UTC").do(sms)
    schedule.every().day.at("11:00 UTC").do(sms)
    schedule.every().day.at("13:00 UTC").do(sms)
    schedule.every().day.at("15:00 UTC").do(sms)
    schedule.every().day.at("17:00 UTC").do(sms)
    schedule.every().day.at("19:00 UTC").do(sms)
    schedule.every().day.at("21:00 UTC").do(sms)
    schedule.every().day.at("23:00 UTC").do(sms)
